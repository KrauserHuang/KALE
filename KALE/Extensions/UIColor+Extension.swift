...
extension UIColor {
    static let klCurry1 = UIColor.convertHexStringToUIColor(hexString: "#352016")
    static let klCurry2 = UIColor.convertHexStringToUIColor(hexString: "#cb5135")
    static let klCurry3 = UIColor.convertHexStringToUIColor(hexString: "#fab476")
    static let klCurry4 = UIColor.convertHexStringToUIColor(hexString: "#66301e")
    static let klCurry5 = UIColor.convertHexStringToUIColor(hexString: "#f4a474")
}
